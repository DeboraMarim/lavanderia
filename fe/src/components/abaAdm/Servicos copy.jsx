...
const Servicos = () => {
  ...
  const [gerenciarCategoriasOpen, setGerenciarCategoriasOpen] = useState(false); // Estado para abrir/fechar gerenciador de categorias
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <button
        onClick={() => setGerenciarCategoriasOpen(!gerenciarCategoriasOpen)} // Alterna a visibilidade do gerenciador de categorias
        style={{
          padding: "10px",
      ...
      {modalOpen && (
        <div
          ...
          onClick={() => setModalOpen(false)} // Fechar ao clicar fora do modal
        >
          <div
            style={{ background: "white", padding: "20px" }}
            onClick={(e) => e.stopPropagation()} // Impede o clique fora de fechar
          >
      ...
      {modalEditServicoOpen && (
        <div
          ...
          onClick={() => setModalEditServicoOpen(false)} // Fechar ao clicar fora do modal
        >
          <div
            style={{ background: "white", padding: "20px" }}
            onClick={(e) => e.stopPropagation()} // Impede o clique fora de fechar
      ...
      {modalCategoriaOpen && (
        <div
          ...
          onClick={() => setModalCategoriaOpen(false)} // Fechar ao clicar fora do modal
        >
          <div
            style={{ background: "white", padding: "20px" }}
            onClick={(e) => e.stopPropagation()} // Impede o clique fora de fechar
